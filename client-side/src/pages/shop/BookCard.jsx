...
const BookCard = ({book,onDelete}) => {
  return (
    <div className='group shadow-md rounded-lg'>
        <div className='aspect-square mb-4 overflow-hidden rounded-lg bg-green-100 p-8 relative group'>
            ...
            <div className='absolute inset-0 bg-black/60 flex items-center justify-center  opacity-0 group-hover:opacity-100  transition-opacity duration-300'>
                <Link to={`/books/${book._id}`} className='bg-green-500 text-white py-2 px-4 rounded cursor-pointer'>View Details</Link>
            </div>
        </div>
        {/* book details */}
